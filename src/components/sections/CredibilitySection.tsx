...
function CredibilitySection() {
  ...
  <div className="max-w-5xl mx-auto text-center space-y-12 px-4 sm:px-6 lg:px-8">
    <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900 leading-tight">Join Over <span className="text-green-600 font-bold">10 Million</span> Satisfied Users </h1>
